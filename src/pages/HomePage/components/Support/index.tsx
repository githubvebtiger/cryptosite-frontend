   ...
   <div style={{ marginTop: '10px', display: 'flex', flexDirection: 'column', gap: '10px'}}>
    <section className="our-interest">
      <div className="left">
        ...
        <p>At Bttrades, we understand the journey every trader embarks on, from the foundation of learning to the mastery of the craft. 
          Whether you're a beginner or a seasoned pro, our platform is designed to support you at every stage.</p>
        <p>Bttrades is your partner in navigating the challenges and unlocking your full potential in the trading world.</p>
      </div>
      <div className="right">
